            ...
            <section className='services-better'>
                ...
                <div className="services-better-content d-f jc-sb align-center">
                    <div className="services-better-points d-f">
                        <dl>
                            <img src="/images/better-icon1.svg" alt="better-icon1" />
                        ...
                        <dl>
                            <img src="/images/better-icon2.svg" alt="better-icon2" />
                        ...
                        <dl>
                            <img src="/images/better-icon3.svg" alt="better-icon3" />
                    ...
                    <div className="services-better-points d-f">
                        <dl>
                            <img src="/images/better-icon4.svg" alt="better-icon1" />
                        ...
                        <dl>
                            <img src="/images/better-icon5.svg" alt="better-icon2" />
                        ...
                        <dl>
                            <img src="/images/better-icon6.svg" alt="better-icon3" />
